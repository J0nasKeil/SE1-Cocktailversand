...
| Er stellt die Forderungen an den Online-Shop und muss uns seine konkreten Wünsche und Anforderungen darlegen.
- Abnahme
- Rahmenbedingungen
- hält Rücksprache mit dem Team
| Mitarbeiter
| Angestellte im Barbetrieb
| Verwendung des online-Shops im Tagesgeschäft
| Kunden
| Kunden des Online-Shops
| Benutzen den Online-Shop. Beeinflussen die Oberfläche der Website.
| Gesetzgeber
| 
| AGB / DSGVO / JuSchG / TMG / 
...
* kundenfreundlich, leicht bedienbar
* Auswahl aus vorgefertigten Produkten oder Zusammenstellung eignener Kreationen
* Auswahl zwischen Alkohol, Säften, Toppings für die eigenen Kreationen
* Anzeige des Warenkorbs (im Warenkorb kann die Anzahl der Cocktails geändert werden)
* unterschieldiche Bezahlmöglichkeiten - Anzeige der Bestellhistorie
* Mindest- Höchstbestellmenge
* Versandkosten werden auf angebotene Cocktails umgelegt
* Falls kein Zahlungseingang, kann der Kunde gesperrt werden
* Rabatte o.ä. für Kunden die Häufig bestellen
* Altersprüfung
